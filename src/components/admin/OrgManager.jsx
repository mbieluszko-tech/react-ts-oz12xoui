    ...
    <div>
      ...
      <div className="form-row">
        <div className="form-group">
          ...
          <input className="form-input" placeholder="np. chor-ack" value={form.slug} onChange={e => handleSlugChange(e.target.value)} />
          {!editOrg && form.slug && (
      ...
      <div className="form-row">
        ...
        <div className="form-group">
          ...
          <input className="form-input" placeholder="Krótki opis grupy" value={form.description} onChange={e => setF("description", e.target.value)} />
        </div>
      </div>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
            {sections.map((sec, idx) => (
              <div key={idx} style={{ display:"flex", gap:8, alignItems:"center" }}>
                ...
                />
                <input className="form-input" placeholder="Nazwa sekcji" value={sec.name} onChange={e => handleSectionChange(idx, "name", e.target.value)} />
                <button type="button" className="btn btn-danger btn-sm" onClick={() => removeSection(idx)} style={{ padding:"6px 10px", flexShrink:0 }}>
                  <Icon name="x" size={13}/>
                </button>
              </div>
            ))}
